...
import pl.ds.util.patternextractor.WildcardPatternExtractor;
...
public final class StringUtil {
    ...
    public static boolean contains(String string, String pattern) {
        PatternExtractor patternExtractor = new WildcardPatternExtractor();
        return new PatternRecognizer(patternExtractor, pattern).findPattern(string);
    }
}